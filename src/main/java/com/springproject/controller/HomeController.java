...
import com.springproject.service.EmpService;
...
public class HomeController {
	...
	public String saveEmp(@ModelAttribute Employee emp, HttpSession session) {
	    ...
	    if (newEmp != null) {
	        ...
	        session.setAttribute("msg", "Something went wrong while saving the employee.");
	    }
	    
	    return "redirect:/loadEmpSave"; // Redirect to the add employee form
	}
    ...
    public String updateEmp(@ModelAttribute Employee emp, HttpSession session) {
        ...
        if (updateEmp != null) {
            ...
            session.setAttribute("msg", "Something went wrong while updating the employee details.");
        }
